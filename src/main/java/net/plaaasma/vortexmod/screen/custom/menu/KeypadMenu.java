...
public class KeypadMenu extends AbstractContainerMenu {
    ...
    public KeypadMenu(int pContainerId, Inventory inv, BlockEntity entity, ContainerData data) {
        super(ModMenuTypes.KEYPAD_MENU.get(), pContainerId);
        checkContainerSize(inv, 1);
        blockEntity = ((KeypadBlockEntity) entity);
...
//        addPlayerHotbar(inv);
    ...
    public boolean stillValid(Player pPlayer) {
        return stillValid(ContainerLevelAccess.create(level, blockEntity.getBlockPos()),
                pPlayer, ModBlocks.KEYPAD_BLOCK.get());
    }
