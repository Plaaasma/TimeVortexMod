       ...
       NoiseBasedChunkGenerator noiseBasedChunkGenerator = new NoiseBasedChunkGenerator(
               MultiNoiseBiomeSource.createFromList(
                        new Climate.ParameterList<>(List.of(
                                Pair.of(Climate.parameters(0.8F, 0.0F, 0.0F, 0.7F, 0.0F, 0.0F, 0.0F), biomeRegistry.getOrThrow(ModBiomes.BLUE_VORTEX_BIOME)),
                                Pair.of(Climate.parameters(0.1F, 1.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F), biomeRegistry.getOrThrow(ModBiomes.ORANGE_VORTEX_BIOME))
                       ))),
