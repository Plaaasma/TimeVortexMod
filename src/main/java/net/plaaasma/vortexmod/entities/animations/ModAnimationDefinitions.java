...
public final class ModAnimationDefinitions {
    public static final AnimationDefinition lost_traveler_walk = AnimationDefinition.Builder.withLength(0.75F).looping()
            ...
            .addAnimation("left_leg", new AnimationChannel(AnimationChannel.Targets.ROTATION,
                    ...
                    new Keyframe(0.5F, KeyframeAnimations.degreeVec(0.0F, 0.0F, 26.25F), AnimationChannel.Interpolations.LINEAR),
                    new Keyframe(0.75F, KeyframeAnimations.degreeVec(0.0F, 0.0F, 0.0F), AnimationChannel.Interpolations.LINEAR)
            ))
